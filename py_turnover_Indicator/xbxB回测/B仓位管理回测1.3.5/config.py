...
pre_data_path = r'E:\quantclass\Bdatas\coin-binance-spot-swap-preprocess-pkl-1h'
...
data_source_dict = {
    ...
    "coin-cap": ('load_coin_cap', r'E:\quantclass\Bdatas\coin-cap',)
}
